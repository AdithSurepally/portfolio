  ...
  return (
    <Link to={`/projects#${project.id}`} className="block group">
        <div className="bg-white rounded-lg shadow-md border border-gray-200 overflow-hidden h-full transition-all duration-300 group-hover:shadow-xl group-hover:border-red-300 group-hover:-translate-y-1">
            <img className="h-56 w-full object-cover" src={project.layoutImg} alt={`${project.title} layout`} />
            <div className="p-6">
                <h3 className="text-2xl font-semibold text-gray-900 mb-2 group-hover:text-red-600 transition-colors">
                    {project.title}
                </h3>
